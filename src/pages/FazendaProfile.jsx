...
import { ArrowLeft, MapPin, Phone, Leaf, Search, X, Share2, QrCode } from 'lucide-react'
import { motion } from 'framer-motion'
import QRCode from 'qrcode.react'

export default function FazendaProfile() {
  const { fazendaSlug } = useParams()
  ...
  const shareUrl = `${window.location.origin}/fazenda/${perfil.slug || perfil.id}`
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-green-100">Página de Rastreabilidade Agrícola</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        >
          ...
          <div className="mt-8 pt-6 border-t flex gap-4 flex-wrap">
            <motion.button
          ...
          {lotesFiltrados.length === 0 ? (
            ...
            lotesFiltrados.map((lote, index) => (
              <motion.a
                ...
                className="block bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow overflow-hidden cursor-pointer"
              >
                <div className="p-6">
                  ...
                  <div className="mt-6 pt-6 border-t">
                    <span className="inline-flex items-center gap-2 text-agro-primary font-semibold group">
      ...
      <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white text-center py-8 mt-12">
        ...
        <p className="text-gray-400 text-sm">
          Rastreabilidade agrícola transparente e certificada
        </p>
      </div>
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-gray-600 mt-6 mb-6">
              Escaneie para compartilhar a página da fazenda
            </p>
            <button
              onClick={() => setSelectedQr(false)}
              className="w-full bg-agro-primary hover:bg-agro-secondary text-white font-semibold py-2 rounded-lg transition-colors"
            >
              Fechar
            </button>
          </motion.div>
